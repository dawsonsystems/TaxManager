...
<div class="body">
    ...
    <g:form method="post" enctype="multipart/form-data">
        ...
        <g:hiddenField name="version" value="${expenseItemInstance?.version}"/>
        <div class="dialog">
            <table>
                <tbody>
                 <tr class="prop">
                    <td valign="top" class="name">
                        <label for="description"><g:message code="expenseItem.description.label" default="Description"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: expenseItemInstance, field: 'description', 'errors')}">
                        <g:textField name="description" id="description" value="${expenseItemInstance.description}"/>
                    </td>
                </tr>
                <tr class="prop">
                    <td valign="top" class="name">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: expenseItemInstance, field: 'amount', 'errors')}">
                        <g:textField name="amount" id="amount" value="${expenseItemInstance.amount}"/>
                    </td>
                </tr>
