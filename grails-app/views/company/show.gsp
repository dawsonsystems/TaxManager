            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="company.clients.label" default="Clients" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="company.yearEnd.label" default="Year End" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: companyInstance, field: "yearEnd")}</td>
