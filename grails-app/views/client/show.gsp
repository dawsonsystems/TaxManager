...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="client.clientOf.label" default="Client Of"/></td>

                <td valign="top" class="value"><g:link controller="company" action="show"
                                                       id="${clientInstance?.clientOf?.id}">${clientInstance?.clientOf?.encodeAsHTML()}</g:link></td>
